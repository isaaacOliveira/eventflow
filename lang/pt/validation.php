...
return [
    ...
    | classe validadora. Algumas destas regras têm várias versões,
    ...
    */
    ...
    'encoding' => 'O campo :attribute deve ter a codificação :encoding.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute indicado apareceu numa fuga de dados. Por favor, escolha um :attribute diferente.',
    ],
    ...
    | especificar rapidamente uma linha de linguagem personalizada para uma regra.
    |
    */

    'custom' => [
        'codigo_qr' => [
            'required' => 'Por favor, leia o código QR ou introduza o código manualmente.',
            'exists' => 'Este código de inscrição não foi encontrado no nosso sistema.',
        ],
    ],
    ...
    | de posição de atributo por algo mais amigável, como "Endereço de E-mail"
